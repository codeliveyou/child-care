...
const RoomPage = () => {
    return (
        <div className="p-5 pt-0 flex gap-5 w-full h-full text-[#374151]">
            <div className="flex-1 flex flex-col gap-5">
                ...
                <div className="relative rounded-xl overflow-hidden">
                    <img src="/call/you.jpg" />
                    <img src="/call/me.png" className="absolute top-5 right-5 w-40 border-[#E9E9F3] border rounded-lg shadow-2xl" />
