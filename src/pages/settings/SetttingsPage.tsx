...
const SettingsPage = () => {
    return (
        <motion.div
            className="flex p-5 pt-0 gap-5 w-full h-full text-[#374151]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            <div className="flex flex-col gap-5 basis-64">
                <div className="bg-white rounded-xl flex-1 flex flex-col gap-2 p-5">
                    <img src="/public/logo/logo1.jpg" className="rounded-xl aspect-square object-cover" alt="Profile" />
                ...
                <div className="bg-white rounded-xl flex-1 p-5 flex flex-col gap-2">
                    ...
                    <div className="text-xs text-[#B6C2E1]">Listan, åtskilda av kommatecken, alla ord för vilka du kan välja rätt svar.</div>
            ...
            <div className="flex flex-col gap-5 flex-1">
                <div className="bg-white rounded-xl flex-[3] p-5 flex flex-col gap-3">
                    ...
                    <div className="text-[#B6C2E1] text-xs">Listan, åtskilda av kommatecken, alla ord för vilka du kan välja rätt svar.</div>
