...
const CustomInput = ({ className = "", ...props }: CustomInputProps) => {
  return (
    <input
      className={twMerge(
        "bg-[#E9E9F3] border border-[#E9E9F3] rounded-lg py-2 px-4",
        className
      )}
      {...props}
    />
...
const AddCalendarEventDialog = ({
  ...
  const createContent = (
    <div className="flex flex-col text-[#374151] gap-5">
      ...
      <div>
        <Button className="float-right" onClick={() => setStatus("update")}>
          Spara
        </Button>
      </div>
    </div>
  ...
  const updateContent = (
    <div className="flex flex-col text-[#374151] gap-3">
      ...
      <div className="justify-end flex">
        <Button backgroundColor="#FFFFFF" textColor="#FF0000">
          Ta bort
        </Button>
