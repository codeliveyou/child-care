...
const DocumentDialog = ({ isOpen, onClose }: DocumentDialogProps) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-4xl w-full"
        ...
        <div className="p-2 relative flex flex-col">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <div className="text-[#211DEF] font-bold text-lg">
                Sofia Rapport
              </div>
            ...
            <div className="items-center flex">
              <button className="py-2 px-4 bg-[#211DEF] text-white rounded-lg">
                Edit
              </button>
            </div>
          </div>
          <div className="p-10">
            ...
            <div>
              ...
              lokaliserad till båda tinningarna samt pannan. Smärtan är intensiv
              och försämrar patientens förmåga att utföra dagliga aktiviteter.
            </div>
            <div>
