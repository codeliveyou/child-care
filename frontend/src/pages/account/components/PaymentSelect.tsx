    ...
    <>
      <div className="w-full flex flex-col" style={{ color: colors.textBlack }}>
        ...
        <label className="flex items-center p-2">
          ...
          <span className="grow ml-4 text-base text-[#6F6F6F]">
            Kort betalning
          </span>
          <img src="/images/auth/klarna.png" width={60} alt="Klarna logo" />
        </label>
        ...
        <div className="bg-[#E9E9F3] p-2 mt-4">
          <ul
            ...
            className="ml-10 font-semibold flex flex-col gap-2"
          >
        ...
        <div style={{ color: colors.blue }} className="underline py-4">
          Läs mer
        </div>
