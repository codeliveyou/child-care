    ...
    <div className="w-full h-full flex items-center justify-center bg-gradient-to-b from-[#6BDCF5] to-[#B6C2E1] relative">
      ...
      <div className="flex w-[60%] h-[70%] z-10 rounded-xl overflow-hidden">
        ...
        <div className="flex-1 bg-[#211DEF] p-10 flex flex-col">
          ...
          <div>
            <Button onClick={() => navigate("/signup")}>Skapa ett konto</Button>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white relative flex items-center justify-center">
          ...
          <div className="flex flex-col w-[60%] gap-3">
            ...
            <div className="text-[#211DEF] underline">
            ...
            <Button
              className="w-full border-[#1D19E542]"
              backgroundColor="#FFF"
              textColor="#B6C2E1"
              onClick={() =>
                navigate("/bank_qr", { state: { qrType: "signin" } })
              }
            >
              Bank ID
            </Button>
            ...
            <div>
              <label className="text-gray-400 flex items-center">
                <input type="checkbox" className="mr-5 w-6 h-6" />
          ...
          <div className="absolute bottom-10 right-10">
            <Button
              textColor="#000"
              backgroundColor="#FFF"
              className="border-[#1D19E542] mr-5 py-2 px-4"
              onClick={() => navigate("/patient_signin")}
            >
              Patient
            </Button>
            <Button
              textColor="#000"
              backgroundColor="#FFF"
              className="border-[#1D19E542] py-2 px-4"
              onClick={() => navigate("/guest_signin")}
            >
              Gäst
            </Button>
          </div>
