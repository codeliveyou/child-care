  ...
  return (
    <>
      ...
      <div className="w-full h-full flex items-center justify-center bg-gradient-to-b from-[#6BDCF5] to-[#B6C2E1] relative">
        ...
        {/* Content container */}
        <div
          className="flex w-[60%] h-[80%] rounded-xl overflow-hidden z-10 relative bg-white"
        ...
        >
          ...
          <Button
            backgroundColor="#FFF"
            textColor="#6F6F6F"
            className="border-[#1D19E542] absolute top-10 left-10"
          ...
          <div className="flex-[3] flex justify-center items-center">
            <div className="w-[90%] flex flex-col gap-3">
              ...
              <div className="text-center text-xl font-extrabold text-[#030303]">
                500 SEK
              </div>
